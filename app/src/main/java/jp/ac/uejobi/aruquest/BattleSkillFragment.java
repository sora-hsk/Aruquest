...
public class BattleSkillFragment extends Fragment {

    static FragmentManager manager;
    static BattleSkillFragment skillFragment;

    public BattleSkillFragment() {}
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_battle_skill,container,false);
    }
}
